...
export const projects: Project[] = [
  {
    ...
    description:
      'A comprehensive frontend focused dashboard designed to help users visualize bulk data returned from nightly ingestions through partner APIs. The dashboard features interactive animated charts and deeply customizable filters, to enable data-driven decision making for music industry professionals.',
    rationale:
  ...
  },
  {
    ...
    rationale:
      'The design of the overall product purposely allows users to complete data entry in non-linear manner, skipping steps as needed, therefore a mechanism for easily identifying outstanding tasks was necessary. In addition, users were often confused about the status of their music release submissions, leading to a high volume of support inquiries and frustration. The dashboard was designed to provide transparency into the submission process, and offer clear guidance on next steps in a hierarchical manner using collapsing panels with alert icons to indicate sections and subsections with remaining tasks and links to the specific forms. ',
    outcomes: [
  ...
  },
  {
    ...
    description:
      'This was a massive overhaul of the sign up flow for new customers to reduce friction in the account creation process as well as encourage product selection and checkout.  The previous process presented the prospective customer with a lengthy form and required the entry of personal bank account payment information before they could even start. This was an opportunity to clean up our 2fa system which had been built in the shadows without design UX considerations and user agreements which were sprinkled throughout the app and needed to be centralized.  In addition this area was modernized and added to our design system and component library to create a more cohesive experience and set the stage for future improvements to the onboarding process and welcome funnel.',
    rationale:
      'This design focuses on simplification, collecting only essentials needed to activate.  It presents a clear path to completion and deposits new users into a welcome funnel to choose their first release type along with explanation of add on features.  The happy path is optimized to place items in the cart for initial purchase, but the customer can opt out and self explore from the dashboard if they choose. The new design offers simplified agreements for acceptance to create an account and log in, and 2fa screens maintain a consistent look and feel with improved UX. There is an underlying tone of encouragement towards selecting items for purchase while always offering access to support resources via chat or help center.',
    outcomes: [
